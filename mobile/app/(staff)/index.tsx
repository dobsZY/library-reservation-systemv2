...
export default function StaffHomeScreen() {
  ...
  /** Sıra: 1) Doluluk–Aktif  2) İptal–Süresi dolmuş  3) QR sol altta (2 sütun ızgarası) */
  const cards: DashboardCard[] = overview
    ? [
        ...
        },
        {
          ...
          accent: '#22C55E',
          iconBg: '#DCFCE7',
          href: '/(staff)/reservations?filter=active',
        },
        {
          ...
          accent: '#4F46E5',
          iconBg: '#EEF2FF',
          href: '/(staff)/reservations?filter=cancelled',
        },
        {
          ...
          accent: '#EF4444',
          iconBg: '#FEE2E2',
          href: '/(staff)/reservations?filter=expired',
        },
        {
          key: 'qr-desk',
          title: 'Masa QR tara',
  ...
  return (
    <View style={styles.page}>
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  router.push(
                    (c.target === 'qr-desk' ? '/(staff)/qr-desk' : STAFF_MASA_KONTROL) as any,
                  );
                }}
      ...
      >
        <Ionicons name="log-out-outline" size={24} color={t.primary} />
      </TouchableOpacity>
    </View>
  );
}
